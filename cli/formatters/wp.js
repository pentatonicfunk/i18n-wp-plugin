	...
	var wpFunc = getGlotPressFunction(properties),
		...
		stringFromFunc = {
			...
			_n:
				...
				' => ' +
				'array( null, _n( ' +
				[properties.single, properties.plural, 1].join(', ') +
				closing +
				'_n( ' +
				[properties.single, properties.plural, 2].join(', ') +
				closing +
				' ),',
			_x:
				properties.single +
				...
				properties.context +
				' ,_x( ' +
				[properties.single, properties.context].join(', ') +
				closing +
				' ),',
			_nx:
				properties.single +
				...
				properties.context +
				'_nx( ' +
				[properties.single, properties.plural, 1, properties.context].join(', ') +
				closing +
				'_nx( ' +
				[properties.single, properties.plural, 2, properties.context].join(', ') +
				closing +
				' ),',
		};
